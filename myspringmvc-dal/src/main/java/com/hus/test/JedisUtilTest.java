...
public class JedisUtilTest {
    ...
    */
    ...
    public void testMap() {
        ...
        //删除map中的某个键值 
        //jedis.hdel("user", "pwd");
        System.out.println(jedis.hmget("user", "pwd")); //password
    ...
    */
    ...
    public void test() throws InterruptedException {
        //keys中传入的可以用通配符 
        System.out.println(jedis.keys("*")); //返回当前库中所1有的key  [sose, sanme, name, jarorwar, foo, sname, java framework, user, braand]
